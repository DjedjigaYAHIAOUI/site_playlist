    ...
    public function register() {
        if ($this->input->post()) {
            ...
            if ($user_id) {
                ...
                redirect($this->session->userdata('redirect_url') ?? 'playlist/create'); // Redirection après inscription
            } else {
    ...
    public function login() {
        if ($this->input->post()) {
            ...
            if ($user) {
                ...
                redirect($this->session->userdata('redirect_url') ?? 'playlist/create'); // Redirection après connexion
            } else {
